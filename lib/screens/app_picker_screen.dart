...
class AppPickerScreen extends StatefulWidget {
  ...
  const AppPickerScreen({super.key, this.lockedPackages = const {}});
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isLocked = widget.lockedPackages.contains(app.packageName);
                      ...
                      return ListTile(
                        ...
                        leading: Opacity(
                          ...
                          child: _buildIcon(app.iconBase64),
                        ),
                        ...
                        subtitle: Text(
                            isLocked ? 'Already locked' : displayPkg,
                            style: TextStyle(
                                fontSize: 12,
                                color: isLocked
